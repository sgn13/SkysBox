      ...
      <div>
        <div className="banner">
          <div className="container">
            <h1>Card Box</h1>
            <p>
              Easily customize greeting cards for every event. Print or send as
              eCard for free!
            </p>
            <NavLink to="/design" className="scroll-link btn1 btn1-white">
              Design your card
            </NavLink>
          </div>
        </div>
        <div className="card">
          ...
          <div className="filter">
            <NavLink to="/filter/card" className="scroll-link">
